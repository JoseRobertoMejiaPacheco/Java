...
public class HolaMundo {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(HolaMundo.CaracteresEspeciales());
        Scanner EntradaPorConsola= new Scanner(System.in);
        System.out.println("Escribe algo :  ");
        ImprimirEntradaDeTeclado(EntradaPorConsola.nextLine());
        HolaMundo.TiposPrimitivos();
    ...
    public static void ImprimirEntradaDeTeclado(String sacanner){
